...
def get_parser():
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help="number of accumulate grad",
    )
...
def compute_loss(
    ...
    with torch.set_grad_enabled(is_training):
        ...
        if params.use_transducer:
            ...
            lm_loss_scale = params.lm_loss_scale
...
def train_one_epoch(
    ...
    for batch_idx, batch in enumerate(train_dl):
        ...
        try:
            ...
            scaler.scale(loss/params.grad_accumulate).backward()
            scheduler.step_batch(params.batch_idx_train)

            if batch_idx%params.grad_accumulate==params.grad_accumulate-1:
